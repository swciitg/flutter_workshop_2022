...
import 'package:swc_flutter/professional_events.dart';
                              ...
                              return InkWell(
                                onTap: () {
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (context) => ProfessionalEvents()));
                                },
                                child: Column(
                                  children: [
                                    Row(
